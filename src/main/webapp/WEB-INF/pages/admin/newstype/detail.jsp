                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Detail newstype</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form class="form-horizontal" method="GET" action="detailNewstype" modelAttribute="newstype">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="inputDescription" class="col-sm-2 control-label">Newstype</label>

                                    <div class="col-sm-10">
                                        <input type="text" path="des" class="form-control" name="des" id="inputDescription" placeholder="Newstype" c:out value="${newstype.des}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputDescriptionEn" class="col-sm-2 control-label">Newstype English</label>

                                    <div class="col-sm-10">
                                        <input type="text" path="desEn" class="form-control" name="desEn" id="inputDescriptionEn" placeholder="Newstype English" c:out value="${newstype.desEn}">
                                    </div>
                                </div>
                                <div class="form-group">
