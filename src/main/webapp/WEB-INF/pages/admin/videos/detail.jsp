                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <div class="box-body pad">
                            <form method="GET" action="detailVideo" modelAttribute="video">
                                <textarea id="editor1" path="des" rows="10" cols="80" placeholder="Place input description khmer">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body pad">
                            <form method="GET" action="detailVideo" modelAttribute="video">
                                <textarea path="desEn" class="textarea" placeholder="Place input description enlish"
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-info">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form class="form-horizontal" method="GET" action="detailVideo" modelAttribute="video">
                            <div class="box-body">
                                <div class="form-group">
