                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <div class="box-body pad">
                            <form method="POST" modelAttribute="video" action="/videos/update/${video.id}" object="${video}" >
                               <%-- <div class="col-sm-10">
                                    <input type="hidden" name="id" class="form-control" id="videoID"
                                           value="${video.id}"/>
                                </div>--%>
                                <textarea id="editor1" path="des" name="des" rows="10" cols="80" placeholder="Place input description khmer">
                                  <c:out value="${video.des}" />
                                </textarea>
                                <div>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body pad">
                            <form method="POST" modelAttribute="video" action="/videos/update/${video.id}" object="${video}">
                                <textarea path="desEn" name="desEn" class="textarea" placeholder="Place input description enlish"
                                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
                                     <c:out value="${video.desEn}" />
                                </textarea>
                                <div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-info">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form class="form-horizontal" method="POST" modelAttribute="video" action="/videos/update/${video.id}" object="${video}">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="inputComment" class="col-sm-2 control-label">Comment</label>

                                    <div class="col-sm-10">
                                        <input type="text" path="comment" class="form-control" id="inputComment" placeholder="Comment">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input path="remoteVideoUrl" type="text" class="form-control" id="inputRemoteURL" placeholder="Remote URL" value="<c:out value="${video.remoteVideoUrl}" />">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input path="localVideo" type="text" class="form-control" id="inputLocalVideo" placeholder="Local Video">
                                    </div>
                                </div>
                            </div>
                        </form>
