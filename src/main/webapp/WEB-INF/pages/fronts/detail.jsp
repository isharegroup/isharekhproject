...
<div class="container">
    <div class="row">
        <div class="col-6">
            <h4 style="background-color: red;height: 61px;">Hello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello Wo</h4>
        </div>
        <div class="row">
            <div class="col-sm-8">
            ...
            <div class="col-sm-4">
                <div class="row">
                    <div class="col-12 col-md-12">
                        <h4>Hello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello Wo</h4>
                    </div>
                    <div class="col-12 col-md-12">
                        <h4 style="background-color: red;height: 61px;">Hello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello Wo</h4>
                    </div>
        ...
        <div class="col-6">
            <h4 style="background-color: red;height: 261px;">Hello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello Wo</h4>
        </div>
    </div>
</div>
